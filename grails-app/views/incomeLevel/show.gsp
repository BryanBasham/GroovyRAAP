        ...
        <div class="body">
            ...
            <div class="dialog">
                ...
                <div id="idDIV" class="prop">
                    <label for="id"><g:message code="incomeLevel.id.label" default="Id" /></label>
                    
                    <div class="value">${fieldValue(bean: incomeLevelInstance, field: "id")}</div>
                ...
                <div id="dbCodeDIV" class="prop">
                    ...
                    <div class="value">${fieldValue(bean: incomeLevelInstance, field: "dbCode")}</div>
                ...
                <div id="rangeDIV" class="prop">
                    ...
                    <div class="value">${fieldValue(bean: incomeLevelInstance, field: "range")}</div>
